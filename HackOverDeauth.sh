...
# TERMINAL COLORS
# https://github.com/Dhineshangamuthu/terminal-colors
NO_COLOR="\e[0m"
WHITE="\e[0;17m"
BOLD_WHITE="\e[1;37m"
BLACK="\e[0;30m"
...
function coolexit()
{
	...
	echo -e " My GitHub:$BOLD_WHITE https://github.com/Dhineshangamuthu"
	exit
}
...
function title() {
	echo -e $BOLD_GREEN
	echo "    //    / /                                                               //    ) ) //   / /  //   / / /__  ___/ //    / /  "
	echo "   //___ / /  ___      ___     / ___      ___              ___      __     //    / / //____    //   / /    / /    //___ / /   "
	echo "  / ___   / //   ) ) //   ) ) //\ \     //   ) ) ||  / / //___) ) //  ) ) //    / / / ____    //   / /    / /    / ___   /    "
	echo " //    / / //   / / //       //  \ \   //   / /  || / / //       //      //    / / //        //   / /    / /    //    / /     "
	echo "//    / / ((___( ( ((____   //    \ \ ((___/ /   ||/ / ((____   //      //____/ / //____/ / ((___/ /    / /    //    / / 	"
	echo -e $BOLD_WHITE
	echo "				By HackOverSecurity"
}
